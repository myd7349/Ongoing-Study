...
- [net-libraries-that-make-your-life-easier](https://github.com/tallesl/net-libraries-that-make-your-life-easier)

### Framework

- [AForge.NET](https://github.com/andrewkirillov/AForge.NET) - [website](http://www.aforgenet.com/framework/)
  - [HP PC Hardware Diagnostics Windows](https://support.hp.com/us-en/help/hp-pc-hardware-diagnostics)
- [Boxed](https://github.com/Dotnet-Boxed/Framework)
- [Cinchoo](https://github.com/Cinchoo/Cinchoo)
...
- [TinyHelpers](https://github.com/marcominerva/TinyHelpers)
...
- [ICSharpCode.SharpZipLib](https://github.com/icsharpcode/SharpZipLib)
  ...
  - [Paillave.Etl.Zip](https://github.com/paillave/Etl.Net/tree/master/src/Paillave.Etl.Zip)
...
- [ant-design-charts-blazor](https://github.com/ant-design-blazor/ant-design-charts-blazor)
...
- [SimpleMvcSitemap](https://github.com/uhaciogullari/SimpleMvcSitemap)

- [Smidge](https://github.com/Shazwazza/Smidge)
...
- [BrowserBoss](https://github.com/StephenCleary/BrowserBoss)
...
- [ConsoleUi](https://github.com/aaubry/ConsoleUi)

- [Ink](https://github.com/zmjack/Ink)

- Mono.Options
  
  - [Pinta](https://github.com/PintaProject/Pinta/blob/master/Pinta/Main.cs)
- [NO_COLOR](https://no-color.org/) - [GitHub](https://github.com/jcs/no_color)
  - [bullseye](https://github.com/adamralph/bullseye)
- [NConsole](https://github.com/RicoSuter/NConsole)
- [NDesk.Options](http://www.ndesk.org/Options)

  - [NDesk.Options](https://github.com/gibbed/NDesk.Options)
...
- [ShellProgressBar](https://github.com/Mpdreamz/shellprogressbar)
  - https://github.com/bezzad/Downloader/blob/master/src/Downloader.Sample/Program.cs
...
- System.CommandLine
  - [bullseye](https://github.com/adamralph/bullseye)
  - [ClangSharpPInvokeGenerator](https://github.com/dotnet/ClangSharp/blob/main/sources/ClangSharpPInvokeGenerator/Program.cs)
...
- [TrueColorConsole](https://github.com/aybe/TrueColorConsole)

- [Utility.CommandLine.Arguments](https://github.com/jpdillingham/Utility.CommandLine.Arguments)

##### DIY

- https://github.com/protobuf-net/protobuf-net/blob/3.0.62/src/protogen/Program.cs
...
- [Deque](https://github.com/StephenCleary/Deque)
  ...
  - [Nito.Collections.Deque](https://www.nuget.org/packages/nito.collections.deque/)
...
- [dotnetCampus.Configurations](https://github.com/dotnet-campus/dotnetCampus.Configurations)
...
- [BindingListView](https://blw.sourceforge.net/)
...
- [NonBlocking](https://github.com/VSadov/NonBlocking)
  - [[BUG] SkiaSharp can call WM_PAINT handler and random COM callbacks when creating or obtaning objects](https://github.com/mono/SkiaSharp/issues/1383)
...
- [CsvReader](https://github.com/microsoft/perfview/tree/main/src/CSVReader)

  - [A Fast CSV Reader](https://www.codeproject.com/Articles/9258/A-Fast-CSV-Reader)
...
- [FormCsvImport](https://github.com/microsoft/XmlNotepad/blob/master/src/Application/FormCsvImport.cs)

- [KBCsv](https://github.com/kentcb/KBCsv)

- [Meziantou.Framework.Csv](https://github.com/meziantou/Meziantou.Framework)

- [MiniExcel.Csv](https://github.com/mini-software/MiniExcel/tree/master/src/MiniExcel/Csv)

- [NLight](https://github.com/slorion/nlight)

  - [A Fast CSV Reader](https://www.codeproject.com/Articles/9258/A-Fast-CSV-Reader)

- [Paillave.Etl.TextFile](https://github.com/paillave/Etl.Net/tree/master/src/Paillave.Etl.TextFile)

- [QuantityTypes.Csv](https://github.com/QuantityTypes/QuantityTypes/blob/main/Source/QuantityTypes.Csv/CsvFile.cs)
...
- [Etl.Net](https://github.com/paillave/Etl.Net) - [website](https://paillave.github.io/Etl.Net/)
...
- [Exceptionless.DateTimeExtensions](https://github.com/exceptionless/Exceptionless.DateTimeExtensions)
...
- [Sparrow Toolkit](https://www.nuget.org/packages/Sparrow.Chart.WP8) - [fork](https://github.com/jcw-/sparrowtoolkit)
...
- [fluentdata](https://github.com/tiesont/fluentdata)
...
- [SqlSugar](https://github.com/donet5/SqlSugar)
  - [起底开源邪教NCC组织](https://github.com/nissl-lab/npoi/wiki/%E8%B5%B7%E5%BA%95%E5%BC%80%E6%BA%90%E9%82%AA%E6%95%99NCC%E7%BB%84%E7%BB%87)
...
- [Mapster](https://github.com/MapsterMapper/Mapster)
  ...
  - [.NET-Backend-Developer-Roadmap](https://github.com/Elfocrash/.NET-Backend-Developer-Roadmap)
...
- [CSharpVitamins.ShortGuid](https://github.com/csharpvitamins/CSharpVitamins.ShortGuid)

  - [.NET Short Unique Identifier](https://stackoverflow.com/questions/9278909/net-short-unique-identifier)

- [flake-idgen.TypeScript.DefinitelyTyped](https://www.nuget.org/packages/flake-idgen.TypeScript.DefinitelyTyped)

- [IdGen](https://github.com/RobThree/IdGen)

- [nanoid-net](https://github.com/codeyu/nanoid-net)

- [Retyped.flake-idgen](https://www.nuget.org/packages/Retyped.flake-idgen)

- [shortid](https://github.com/bolorundurowb/shortid/)

  - [YouTube-like GUID](https://stackoverflow.com/questions/1458468/youtube-like-guid)

##### Fake Data

- [Faker.Net](https://github.com/jonwingfield/Faker.Net)

- [Faker.Net](https://github.com/Kuree/Faker.Net)

- [RandomFriendlyNameGenerator](https://github.com/bartosz-jarmuz/RandomFriendlyNameGenerator)
...
- [Community.CsharpSqlite](https://github.com/MatterHackers/MatterControl/tree/main/Community.CsharpSqlite)

- [Dapper.Bulk](https://github.com/KostovMartin/Dapper.Bulk)

- [DataObjects.NET](https://github.com/DataObjects-NET/dataobjects-net)

- [DbUtility](https://github.com/Ivony/DbUtility)

- [DynamicMapper](https://github.com/Rem0o/DynamicMapper)
...
- [Microsoft.Data.Sqlite](https://www.nuget.org/packages/Microsoft.Data.Sqlite/#versions-body-tab)
...
- [Open.Database.Extensions](https://github.com/Open-NET-Libraries/Open.Database.Extensions)
...
- [SqlQueryBuilder](https://github.com/Rem0o/SqlQueryBuilder)
...
- [SyncChanges](https://github.com/mganss/SyncChanges)

- [System.Linq.Dynamic](https://github.com/zzzprojects/System.Linq.Dynamic.Core)
  
  - [How can i use a list of objects instead of a DataTable as DataSource?](https://github.com/davidegironi/advanceddatagridview/issues/24)
...
- [SolidSample](https://github.com/ardalis/SolidSample)
...
- [structuremap](https://github.com/structuremap/structuremap)
  ...
  - [IoC, Dll References, and Assembly Scanning](https://stackoverflow.com/questions/809051/ioc-dll-references-and-assembly-scanning)

  - [Dependency Injection - Choose DLL and class implementation at runtime through configuration file](https://stackoverflow.com/questions/6365539/dependency-injection-choose-dll-and-class-implementation-at-runtime-through-co)
...
- [PostSharp](https://www.postsharp.net/)
  ...
  - [使用PostSharp在.NET平台上实现AOP](https://www.cnblogs.com/leoo2sk/archive/2010/11/30/aop-postsharp.html)

  - [WPF UserControl DependencyProperty do not have BindingExpression?](https://learn.microsoft.com/en-us/answers/questions/751742/wpf-usercontrol-dependencyproperty-not-bindingexpr.html)

  - [Dependency Property](https://doc.postsharp.net/dependency-property)

##### DDD

- [DDD-School](https://github.com/mizrael/DDD-School)
...
- [Splat.DI](https://github.com/reactiveui/Splat.DI.SourceGenerator)
...
- Articles
  ...
  - [How to perform dependency injection through Microsoft.Extensions.Hosting in wpf](https://stackoverflow.com/questions/66196449/how-to-perform-dependency-injection-through-microsoft-extensions-hosting-in-wpf)

  - [Dependency injection guidelines](https://learn.microsoft.com/en-us/dotnet/core/extensions/dependency-injection-guidelines)

  - [Using Factory Pattern with ASP.NET Core Dependency Injection](https://stackoverflow.com/questions/54127414/using-factory-pattern-with-asp-net-core-dependency-injection)
  ...
  - [Ioc](https://learn.microsoft.com/en-us/windows/communitytoolkit/mvvm/ioc)

  - [How to handle layer specific Dependency Injection in a reusable dll with ninject?](https://stackoverflow.com/questions/28767425/how-to-handle-layer-specific-dependency-injection-in-a-reusable-dll-with-ninject)

  - [Dependency Inject (DI) "friendly" library](https://stackoverflow.com/questions/2045904/dependency-inject-di-friendly-library)
...
- YouTube Videos
  ...
  - [Design Patterns: Dependency Inversion Principle Explained Practically in C# (The D in SOLID)](https://www.youtube.com/watch?v=NnZZMkwI6KI&t=15s)
...
- [MinIoC](https://github.com/microsoft/MinIoC)
...
- [PipelinePatternImplementations](https://github.com/michaelscodingspot/PipelinePatternImplementations)
...
- [CommunityToolkit.Diagnostics](https://docs.microsoft.com/zh-cn/windows/communitytoolkit/developer-tools/throwhelper)
  ...
  - [When should I use a ThrowHelper method instead of throwing directly?](https://stackoverflow.com/questions/1980044/when-should-i-use-a-throwhelper-method-instead-of-throwing-directly)
...
- [GlobalExceptionHandlerDotNet](https://github.com/josephwoodward/GlobalExceptionHandlerDotNet)
...
- ThrowHelper.cs
  ...
  - Search file `ThrowHelper.cs` in https://github.com/dotnet/runtime.

- [Try](https://github.com/StephenCleary/Try)
...
- [MoltenEngine](https://github.com/Syncaidius/MoltenEngine)

- [Monofoxe](https://github.com/Martenfur/Monofoxe)
...
- [automatic-graph-layout](https://github.com/microsoft/automatic-graph-layout)
  ...
  - [.NET graph library around?](https://stackoverflow.com/questions/1578493/net-graph-library-around)

- [GraphSharp](https://github.com/prepare/GraphSharp)
...
- [ActiViz.NET](https://vtk.org/Wiki/VTK/CSharp/ActiViz.NET)
...
- [CairoSharp](https://github.com/zwcloud/CairoSharp)
...
- [curves](https://github.com/burningmime/curves) - [gitlab](https://gitlab.com/burningmime/curves)

  - [How can I fit a Bézier curve to a set of data?](https://stackoverflow.com/questions/5525665/smoothing-a-hand-drawn-curve)

  - [Smoothing a hand-drawn curve](https://stackoverflow.com/questions/5525665/smoothing-a-hand-drawn-curve)

- [d2dlib](https://github.com/jingwood/d2dlib)
...
- [OpenTK](https://github.com/opentk/opentk)
  ...
  - [ImGui.NET_OpenTK_Sample](https://github.com/NogginBops/ImGui.NET_OpenTK_Sample)
...
- SDL
  ...
  - [SDL_WPF_Interop](https://github.com/BeardedPlatypus/SDL_WPF_Interop)

  - [在 WPF 中调用 SDL2 播放 RGB/YUV](https://blog.naturalwill.me/2017/03/07/display-RGB-or-YUV-by-SDL2-in-WPF/)

  - [在WPF中使用SDL](https://blog.csdn.net/chenxiemin/article/details/40512073)

  - [Silk.NET](https://github.com/dotnet/Silk.NET)

  - [SDL#](https://github.com/flibitijibibo/SDL2-CS)

  - [Veldrid.SDL2](https://github.com/mellinoe/veldrid/tree/master/src/Veldrid.SDL2)
...
- [Silk.NET](https://github.com/dotnet/Silk.NET)
  ...
  - [SilkyNvg](https://github.com/SilkCommunity/SilkyNvg): nanovg
...
- [SkiaSharp](https://github.com/mono/SkiaSharp)
  ...
  - [Avalonia.Skia.Internals](https://github.com/BeyondDimension/SteamTools/tree/develop/src/Avalonia.Skia.Internals)

  - [CopyBitmap](https://github.com/MichaelRumpler/CopyBitmap)

    - [[QUESTION] Copy a rectangular area within a bitmap](https://github.com/mono/SkiaSharp/issues/842)

  - [CSharpMath.SkiaSharp](https://github.com/verybadcat/CSharpMath)

  - [Emby.Drawing.Skia](https://github.com/MediaBrowser/Emby/tree/master/Emby.Drawing.Skia)

  - [KimonoDesigner](https://github.com/xamarin/KimonoDesigner)
  ...
  - [SkiaSharp.Elements](https://github.com/FelipeNicoletto/SkiaSharp.Elements)
  ...
  - [SkiaTextRenderer](https://github.com/ryancheung/SkiaTextRenderer)

    - [Add SkiaTextBox to simplify text rendering and layouting](https://github.com/mono/SkiaSharp/issues/692)

  - [standard-ui](https://github.com/dotnet-standard-ui/standard-ui)

  - [wpf-skia-opengl](https://github.com/freezy/wpf-skia-opengl)

  - [WpfToSkia](https://github.com/royben/WpfToSkia)
...
- [SVG](https://github.com/svg-net/SVG)
  ...
  - [Using Vector (SVG) Graphics in C# .NET](https://lasithapetthawadu.wordpress.com/2014/02/24/using-vector-svg-graphics-in-c-net/) - [code](https://github.com/lasitha-petthawadu/CSharp-svg)

- [SVGImage](https://github.com/dotnetprojects/SVGImage)

- [SvgImageSource](https://github.com/muak/SvgImageSource)
...
- [GTK#](https://github.com/GtkSharp/GtkSharp)
  ...
  - [FormsGtkLive](https://github.com/jsuarezruiz/FormsGtkLive)
...
- [uno](https://github.com/unoplatform/uno)
  ...
  - [Chinook.Navigation](https://github.com/nventive/Chinook.Navigation)
...
- [Hotkey Editor Control in WPF](https://tyrrrz.me/blog/hotkey-editor-control-in-wpf)

  - https://github.com/Tyrrrz/LightBulb/blob/master/LightBulb/Views/Controls/HotKeyTextBox.cs

- [WPF: Implementing Global Hot Keys](https://social.technet.microsoft.com/wiki/contents/articles/30568.wpf-implementing-global-hot-keys.aspx)

- [Keyboard shortcuts in WPF](https://stackoverflow.com/questions/1361350/keyboard-shortcuts-in-wpf)

- [Is there any way to global hook the mouse actions like i'm hooking the keyboard keys?](https://stackoverflow.com/questions/44990335/is-there-any-way-to-global-hook-the-mouse-actions-like-im-hooking-the-keyboard)

- [Enabling Hot Keys (Short Cut keys) for windows Application](https://www.codeproject.com/Articles/27367/Enabling-Hot-Keys-Short-Cut-keys-for-windows-Appli)

- [Global Shortcuts in WinForms and WPF](https://www.codeproject.com/Articles/442285/Global-Shortcuts-in-WinForms-and-WPF)

- https://github.com/cuiliang/Caps2CtrlSpace/blob/master/src/KeyMapper.cs
...
- [Multilingual-App-Toolkit](https://github.com/microsoft/Multilingual-App-Toolkit) - [extension](https://marketplace.visualstudio.com/items?itemName=dts-publisher.mat2022)

  - [ambie](https://github.com/jenius-apps/ambie)

- [NETworkManager.Localization](https://github.com/BornToBeRoot/NETworkManager/tree/main/Source/NETworkManager.Localization)

- [NGettext](https://github.com/VitaliiTsilnyk/NGettext)
  
  - [Pinta](https://github.com/PintaProject/Pinta)

- [osu-localisation-analyser](https://github.com/ppy/osu-localisation-analyser)

- [Resource Generator](https://marketplace.visualstudio.com/items?itemName=DonAirey.ResourceGenerator)
...
- [ScreenToGif/Translator](https://github.com/NickeManarin/ScreenToGif/tree/master/Other/Translator)

  - [LOCALIZATION](https://github.com/NickeManarin/ScreenToGif/blob/master/LOCALIZATION.md)

- [ST.Tools.Translate](https://github.com/BeyondDimension/SteamTools/tree/develop/src/ST.Tools.Translate)
...
- [BinaryFileSchema](https://github.com/Andos/BinaryFileSchema)
...
- [HostFileChangeMonitor](https://github.com/dotnet/runtime/blob/main/src/libraries/System.Runtime.Caching/src/System/Runtime/Caching/HostFileChangeMonitor.cs)

  - [MemoryCache](https://learn.microsoft.com/en-us/dotnet/api/system.runtime.caching.memorycache?view=dotnet-plat-ext-6.0)
...
- [Microsoft.Extensions.FileSystemGlobbing](https://docs.microsoft.com/en-us/dotnet/core/extensions/file-globbing)
  ...
  - https://github.com/dotnet/Silk.NET/blob/main/src/Core/Silk.NET.BuildTools/Generator.cs
...
- Newtonsoft.Json.Bson
  ...
  - [ChoETL.BSON](https://github.com/Cinchoo/ChoETL/tree/master/src/ChoETL.BSON)

- [NJsonSchema](https://github.com/RicoSuter/NJsonSchema)

  - [NETworkManager](https://github.com/BornToBeRoot/NETworkManager)

- [JsonExtensions](https://github.com/Tyrrrz/JsonExtensions)
...
- [System.Text.Json](https://www.nuget.org/packages/System.Text.Json)
  ...
  - [Add Bson integration](https://github.com/dotnet/runtime/issues/1127)
...
- ClangSharp
  ...
  - [Silk.NET.BuildTools](https://github.com/dotnet/Silk.NET/blob/main/src/Core/Silk.NET.BuildTools/Cpp/ClangPreprocessor.cs)
...
- [CppAst.NET](https://github.com/xoofx/CppAst.NET)
  ...
  - [SkiaSharpGenerator](https://github.com/mono/SkiaSharp/tree/main/utils/SkiaSharpGenerator)

    - [SkiaSharp](https://github.com/mono/SkiaSharp/blob/main/binding/libSkiaSharp.json)
...
- [Hebron](https://github.com/HebronFramework/Hebron)
...
- [Python.NET](http://pythonnet.github.io/)
  ...
  - [Python.Included](https://github.com/henon/Python.Included)
    ...
    - [CodeMinion](https://github.com/SciSharp/CodeMinion)

      - [Numpy.NET](https://github.com/SciSharp/Numpy.NET)

        - [Numpy.NET/Numpy/np.fft.gen.cs](https://github.com/SciSharp/Numpy.NET/blob/master/src/Numpy/np.fft.gen.cs)

  - [LessMsi.py](https://github.com/activescott/lessmsi/blob/master/contrib/python/LessMsi.py)

##### C# <-> VB.NET

- [CodeConverter](https://github.com/icsharpcode/CodeConverter)
...
- [ZetaResourceEditor/LicenseGenerator](https://github.com/UweKeim/ZetaResourceEditor/tree/master/Source/LicenseGenerator)
...
- [Duality](https://github.com/AdamsLair/duality/tree/master/Source/Core/Duality/Utility/Log)

- [ELMAH](https://elmah.io/)

- fuslogvw.exe

  - [WPF App Fails With System.MissingMethodException](https://stackoverflow.com/questions/713384/wpf-app-fails-with-system-missingmethodexception)
...
- [log4net](https://github.com/apache/logging-log4net)
  ...
  - [YalvLib](https://github.com/Dirkster99/YalvLib): YalvLibLib is a WPF/MVVM log4net viewer library based on an earlier Winforms Yalv version from codeplex.

- [LogUtility](https://github.com/Ivony/LogUtility)
...
- [NLog](https://github.com/NLog/NLog)
  ...
  - [LoggingPerformance](https://github.com/panchengtao/LoggingPerformance)

- [NReco.Logging.File](https://github.com/nreco/logging)

- [PostSharp.Patterns.Diagnostics](https://www.nuget.org/packages/PostSharp.Patterns.Diagnostics/) - [website](https://www.postsharp.net/download/nuget)
...
- [serilog](https://github.com/serilog/serilog)
  ...
  - [serilog-sinks-udp](https://github.com/FantasticFiasco/serilog-sinks-udp)
...
- [NMath](https://www.nuget.org/packages/CenterSpace.NMath.Standard.Windows.X64)

- [NonLinearEquationsSolver](https://github.com/EduardBargues/NonLinearEquationsSolver)

- [Numpy.NET](https://github.com/SciSharp/Numpy.NET)

- [SimpleExpressionEngine](https://github.com/toptensoftware/SimpleExpressionEngine)
...
- [UpsilonGC](https://github.com/kkokosa/UpsilonGC)

##### Articles

- [Demystifying Memory Profilers in C# .NET Part 1: The Principles](https://michaelscodingspot.com/memory-profilers-principles/)

- [Demystifying Memory Profilers in C# .NET Part 2: Memory Leaks](https://michaelscodingspot.com/memory-profilers-for-memory-leaks/)

- [Demystifying Memory Profilers in C# .NET Part 3: Memory Pressure](https://michaelscodingspot.com/fix-memory-pressure-dotnet/)

### Messaging

- [Namotion.Messaging](https://github.com/RicoSuter/Namotion.Messaging)

### MIME

- [Using .NET, how can you find the mime type of a file based on the file signature not the extension](https://stackoverflow.com/questions/58510/using-net-how-can-you-find-the-mime-type-of-a-file-based-on-the-file-signature?lq=1)
...
- [FFmpeg.NET](https://github.com/cmxl/FFmpeg.NET)
  ...
  - [FFmpegLite.NET](https://github.com/chadzhao/FFmpegLite.NET)

- [FFMpegCore](https://github.com/rosenbjerg/FFMpegCore)

  - [Render Video with SkiaSharp](https://swharden.com/csdv/skiasharp/video/) - [code](https://github.com/swharden/Csharp-Data-Visualization/tree/main/projects/skiasharp/video/)

- [FlashCap](https://github.com/kekyo/FlashCap)

- [HanumanInstitute.FFmpeg](https://github.com/mysteryx93/HanumanInstitute.FFmpeg)

- [jellyfin](https://github.com/jellyfin/jellyfin)

- [MediaInfo.DotNetWrapper](https://github.com/StefH/MediaInfo.DotNetWrapper)

- [MediaInfoDLL.cs](https://github.com/MediaArea/MediaInfoLib/blob/master/Source/MediaInfoDLL/MediaInfoDLL.cs)
...
- [MimeTypes](https://github.com/khellang/MimeTypes)
  - [Paillave.Etl.Mail](https://github.com/paillave/Etl.Net/tree/master/src/Paillave.Etl.Mail)
...
- [Refit](https://github.com/reactiveui/refit)
  - [.NET-Backend-Developer-Roadmap](https://github.com/Elfocrash/.NET-Backend-Developer-Roadmap)
- [Renci.SshNet](https://github.com/zeevl/Renci.SshNet)
...
- Microsoft.Office.Interop.Outlook
  - [OutlookCloseToMinimize](https://github.com/dinhngtu/OutlookCloseToMinimize)
...
- [ExcelMapper](https://github.com/mganss/ExcelMapper)
- [ExcelDataReader](https://github.com/ExcelDataReader/ExcelDataReader)
  - [Paillave.Etl.ExcelFile](https://github.com/paillave/Etl.Net/tree/master/src/Paillave.Etl.ExcelFile)
...
- [irony](https://github.com/daxnet/irony)
...
- [AdamsLair.Duality.Editor.Plugins.Base](https://www.nuget.org/packages/AdamsLair.Duality.Editor.Plugins.Base/)
- [Artemis.Core/Plugins](https://github.com/Artemis-RGB/Artemis/tree/master/src/Artemis.Core/Plugins)
...
- :star: [PluginFramework](https://github.com/weikio/PluginFramework)
...
- [MiniProfiler](https://miniprofiler.com/) - [Code](https://github.com/MiniProfiler/dotnet)

- [MsrUtil](https://github.com/clamchowder/MsrUtil)
...
- [DotNetPELib](https://github.com/LADSoft/DotNetPELib)
  ...
  - [PeLib](https://github.com/rochus-keller/PeLib)

- [TypeExtender](https://github.com/NdubuisiJr/TypeExtender)
...
- [ThisAssembly](https://github.com/devlooped/ThisAssembly)
...
- [C# to C# Communication: REST, gRPC and everything in between](https://michaelscodingspot.com/rest-vs-grpc-for-asp-net/)
- [BoincRpc](https://github.com/chausner/BoincRpc)
- [CoreRPC](https://github.com/kekekeks/CoreRPC)
- GRpc
  - DeepL Translate App for Windows
- [grpc-dotnet-namedpipes](https://github.com/cyanfish/grpc-dotnet-namedpipes)
...
- [Bond](https://github.com/microsoft/bond/)
  ...
  - Bond.dll, Bond.IO.dll, Bond.JSON.dll, Bond.Reflection.dll
...
- [Google Protobuffers](https://github.com/protocolbuffers/protobuf/tree/main/csharp)
  ...
  - [protobuf-net](https://github.com/protobuf-net/protobuf-net)
    ...
    - https://github.com/quasar/Quasar/blob/master/Quasar.Common/Video/Resolution.cs
...
- [Comparing Protobuf, JSON, BSON, XML with .NET for File streams](https://damienbod.com/2014/01/09/comparing-protobuf-json-bson-xml-with-net-for-file-streams/)

  - [SerializationToFileTests](https://github.com/damienbod/SerializationToFileTests)

- [Protobuf In C# .NET – Part 4 – Performance Comparisons](https://dotnetcoretutorials.com/2022/01/18/protobuf-in-c-net-part-4-performance-comparisons/)

  - [SerializerTests](https://github.com/Alois-xx/SerializerTests)
...
- [StateMechanic](https://github.com/canton7/StateMechanic)
...
- [CodegenCS](https://github.com/CodegenCS/CodegenCS)
...
- [Veil](https://github.com/csainty/Veil)
  - [Papercut-SMTP](https://github.com/ChangemakerStudios/Papercut-SMTP)
...
- [Open.ChannelExtensions](https://github.com/Open-NET-Libraries/Open.ChannelExtensions)
...
- [xunit](https://github.com/xunit/xunit)
  ...
  - [Test Driven Development Process with XUnit](https://www.codeproject.com/Articles/5322646/Test-Driven-Development-Process-with-XUnit) - [code](https://github.com/npolyak/NP.TestDrivenSample)
...
- [BuildVersioning](https://github.com/TurnerSoftware/BuildVersioning)

- [CenterCLR.RelaxVersioner](https://github.com/kekyo/CenterCLR.RelaxVersioner)
...
- [WebCrawler](https://github.com/meziantou/WebCrawler)
...
- [webview2-control](https://github.com/michael-russin/webview2-control)
...
- [YamlDotNet](https://github.com/aaubry/YamlDotNet)
  ...
  - [NJsonSchema.Yaml](https://github.com/RicoSuter/NJsonSchema/tree/master/src/NJsonSchema.Yaml)
