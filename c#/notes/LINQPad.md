1. [Customing Dump Output](https://www.linqpad.net/CustomizingDump.aspx)
...
5. [teamcity-csharp-interactive](https://github.com/JetBrains/teamcity-csharp-interactive)
6. [dotnet-repl](https://github.com/jonsequitur/dotnet-repl)
7. [dotnet-script](https://github.com/dotnet-script/dotnet-script)
8. [RoslynPad](https://github.com/roslynpad/roslynpad)
