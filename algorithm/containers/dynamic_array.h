...
bool dyarr_remove_range(dyarr_t arr, size_t begin, size_t end, dyarr_t *removed);
size_t dyarr_index(dyarr_t arr, void *data);
size_t dyarr_rindex(dyarr_t arr, void *data);
void dyarr_reverse(dyarr_t arr);
size_t dyarr_count(dyarr_t arr, void *data);
bool dyarr_get_auto_delete(dyarr_t arr);
void dyarr_set_auto_delete(dyarr_t arr, bool auto_delete);
