...
int main() {
...
#if defined(BMP_TEXTURE)
  GLuint texture = loadBMP_custom("uvtemplate.bmp");
#elif defined(USE_LOADDDSEX)
  ...
  // (I copied these lines from https://github.com/opengl-tutorials/ogl/blob/master/tutorial05_textured_cube/tutorial05.cpp)
