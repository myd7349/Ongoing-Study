...
function(vcpkg_check_features)
    ...
    foreach(_vcf_ARG ${ARGN})
        if(_vcf_IS_FEATURE_ARG)
            ...
            message(STATUS ">>> ${_vcf_FEATURE_VAR}=${${_vcf_FEATURE_VAR}}")
            set(_vcf_IS_FEATURE_ARG 1)
        endif()
    endforeach()
...
# https://stackoverflow.com/questions/6678861/cmake-creating-and-building-a-list-within-a-function-with-directory-or-glob
# https://github.com/microsoft/vcpkg/pull/6958
