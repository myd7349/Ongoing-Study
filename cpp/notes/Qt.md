...
- [Autopilot in Launchpad](https://launchpad.net/autopilot)
  ...
  - [Automated GUI testing with Autopilot](https://xapantu.wordpress.com/2013/06/17/automated-testing-with-autopilot/)
  
  - [autopilot-qt](https://code.launchpad.net/autopilot-qt)
    
    - [RocketPilot](https://github.com/uglide/RocketPilot)
