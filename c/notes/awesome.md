...
- [gmeteor](http://gmeteor.sourceforge.net/): gmeteor is a tool for designing discrete-time equiripple filters with linear phase and a finite impulse response (FIR).
...
- [CacheLineSize](https://github.com/NickStrupat/CacheLineSize)
